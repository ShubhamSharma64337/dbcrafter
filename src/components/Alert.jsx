...
export default function Alert({alert,closeAlert}) {
    return (    
                            <div className={`${alert?'left-0':'-left-full'} z-20 bg-blue-700 shadow transition-all fixed bottom-2 px-4 py-3 rounded-r-md flex justify-between items-center text-white`}>
