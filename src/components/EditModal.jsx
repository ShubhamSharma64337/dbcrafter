        ...
        <div className="modal bg-white rounded">
            ...
            <form className="flex flex-col overflow-auto">
                    <div className="formItem mb-3">
                        ...
                        <input name='tblName' id='tableName' className="border p-2" value={updatedTbl.name} onChange={handleNameChange} type='text' placeholder='Enter the table name'></input>
                    </div>
                    <table className='text-center border' cellPadding={15} cellSpacing={5}>
                      ...
                      <tbody>
                        ...
                        {updatedTbl.fields.map((element, index)=>{
                          ...
                          <td>
                            <input name='name' type='text' className='border p-2' value={updatedTbl.fields[index].name} data-rowindex={index} placeholder='Enter table name' onChange={handleChange}></input>
                          </td>
                          <td>
                          ...
                          <td>
                            <input name='pKey' type='checkbox' className='border p-2 w-5 h-5' checked={element.name===updatedTbl.pKey?true:false} data-rowindex={index} onChange={handleChange}></input>
                          </td>
                          <td>
                            <input name='isFKey' type='checkbox' className='border p-2 w-5 h-5' checked={updatedTbl.fields[index].isFKey} data-rowindex={index} onChange={handleChange}></input>
                          </td>
                          <td>
