        ...
        <div className={`modal ${theme==='dark'?'bg-gray-950 text-white':'bg-white'} rounded`}>
            ...
            <form className="flex flex-col overflow-auto">
                    <div className="formItem my-3">
                        ...
                        <input required={true} name='diagramName' id='diagramName' value={diagramName?diagramName:''} onChange={handleChange} className={`border p-2 ${theme==='dark'?'bg-gray-900 focus:outline-none border-slate-700 focus:border-blue-500':'outline-blue-500'} w-full`} type='text' placeholder='Enter the diagram name'></input>
                    </div>
