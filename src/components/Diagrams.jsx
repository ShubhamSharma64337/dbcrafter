...
export default function Diagrams({authInfo, showAlert, setDiagram}) {
    ...
    return (
    diagrams ? <div className='p-5 grid gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-4 '>
              ...
              <div key={index} className="card p-1 rounded-lg border-2 border-blue-50 shadow-lg flex flex-col justify-center items-center transition overflow-hidden hover:shadow hover:border-2 hover:border-blue-400">
                  ...
                  <div className="body rounded bg-blue-50 flex justify-between items-center w-full overflow-x-auto p-3">
                      <div className='left flex items-center gap-x-2'>
                        <input type='text' id={element.name+'Input'} defaultValue={element.name} className="diagram-name rounded enabled:px-1 py-0.5 outline-blue-700 enabled:border disabled:bg-blue-50" disabled={element.isEditing?false:true} data-diagramname={element.name}/>
                      </div>
