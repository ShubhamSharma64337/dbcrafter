...
export default function Diagrams({authInfo, showAlert}) {
    ...
    diagrams ? <div className='flex gap-5 p-10 flex-col md:flex-row'>
        {diagrams.map((element)=>{
            return (
            <button className="card rounded-lg border-2 border-blue-50 shadow-lg flex flex-col justify-center items-center transition overflow-hidden hover:shadow hover:border-2 hover:border-blue-400">
