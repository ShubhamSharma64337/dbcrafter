...
export default function DeleteAccount({setCurrentPath}) {
    useEffect(()=>{
  ...
  return (
    ...
    <div className='px-10 py-5'>
        <form>
            ...
            <div className="my-5 flex flex-col gap-y-1">
                <button type='button' className='bg-blue-600 rounded p-2 font-medium text-slate-50 hover:bg-blue-500'>Delete</button>
            </div>
        </form>
    </div>
  )
