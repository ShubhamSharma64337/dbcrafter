...
export default function Loader({theme, isLoading}) {
  return (
    isLoading && <div className={`overlay z-10 overflow-auto fixed justify-center md:justify-center  flex flex-col gap-y-2 items-center pt-5 top-0 w-screen h-screen ${theme==='dark'?'bg-black':'bg-white'} bg-opacity-75`}>
