...
export default function Settings({theme,urls,currentPath}) {
  return (
    <div className='grid grid-cols-4 grid-rows-5 lg:grid-rows-1 h-screen p-5 rounded bg-gradient-to-r from-blue-700 to-purple-500 gap-2'>
            <div className='left flex justify-center items-center p-5 border-e h-full bg-white rounded-lg lg:rounded-s-lg col-span-4 lg:col-span-1 lg:block row-span-1 lg:row-span-5  overflow-x-auto'>
            ...
            <div className="right col-span-4 lg:col-span-3 lg:p-10 bg-white rounded-lg lg:rounded-e-lg row-span-4 lg:row-span-5">   
                <Outlet/>
            </div>
    </div>
  )
