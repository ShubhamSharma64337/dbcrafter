            ...
            <form className="flex flex-col overflow-auto">
                    <div className="mb-3 p-1">
                        ...
                        <div className='flex gap-x-2'>
                          ...
                          <button onClick={autoFill} type="button" className={`h-min p-2 rounded-full disabled:bg-slate-300  group relative ${theme==='dark'?'bg-purple-400 hover:bg-purple-500':'bg-purple-100 hover:bg-purple-200'}`} disabled={authInfo?false:true}>
